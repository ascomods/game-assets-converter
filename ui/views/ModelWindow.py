...
# Form implementation generated from reading ui file 'ui/views/ModelWindow.ui'
#
...
class Ui_ModelWindow(object):
    def setupUi(self, ModelWindow):
        ...
        ModelWindow.resize(662, 480)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(ModelWindow.sizePolicy().hasHeightForWidth())
        ModelWindow.setSizePolicy(sizePolicy)
        ModelWindow.setMinimumSize(QtCore.QSize(662, 480))
        ModelWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ModelWindow.setWindowTitle("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/db.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ModelWindow.setWindowIcon(icon)
        ModelWindow.setStyleSheet("* {\n"
"   font: 9pt \"Montserrat\";\n"
...
"    height: 0px;\n"
"}")
        ModelWindow.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        ...
        self.actionsGrpBox.setMinimumSize(QtCore.QSize(280, 0))
        self.actionsGrpBox.setMaximumSize(QtCore.QSize(280, 16777215))
    ...
    def retranslateUi(self, ModelWindow):
        ...
        self.gameGrpBox.setTitle(_translate("ModelWindow", "Game"))
        self.platformGrpBox.setTitle(_translate("ModelWindow", "Platform"))
        self.actionsGrpBox.setTitle(_translate("ModelWindow", "Actions"))
        self.contentGrpBox.setTitle(_translate("ModelWindow", "Content"))
...
if __name__ == "__main__":
    ...
    ModelWindow = QtWidgets.QMainWindow()
    ui = Ui_ModelWindow()
    ui.setupUi(ModelWindow)
    ModelWindow.show()
    sys.exit(app.exec_())
