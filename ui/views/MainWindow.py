...
"}")
        ...
        self.options_frame.setMaximumSize(QtCore.QSize(16777215, 50))
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.options_frame)
        self.horizontalLayout.setObjectName("horizontalLayout")
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem6)
        self.blender_chk_box = QtWidgets.QCheckBox(self.options_frame)
        self.blender_chk_box.setObjectName("blender_chk_box")
        self.horizontalLayout.addWidget(self.blender_chk_box)
        spacerItem7 = QtWidgets.QSpacerItem(50, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem7)
        self.debug_chk_box = QtWidgets.QCheckBox(self.options_frame)
        self.debug_chk_box.setObjectName("debug_chk_box")
        self.horizontalLayout.addWidget(self.debug_chk_box)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem8)
        self.verticalLayout.addWidget(self.options_frame)
        spacerItem9 = QtWidgets.QSpacerItem(0, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
